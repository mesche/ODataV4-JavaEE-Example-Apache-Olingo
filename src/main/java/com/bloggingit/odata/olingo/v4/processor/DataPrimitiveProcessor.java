 ...
 */
public class DataPrimitiveProcessor implements PrimitiveProcessor {
    ...
    public DataPrimitiveProcessor(OlingoDataService dataService, MetaEntityDataCollection metaEntityDataCollection) {
